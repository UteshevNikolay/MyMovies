...
public class JSONUtils {
    ...
    public static final String SMALL_POSTERS_SIZE = "w185";
    public static final String BIG_POSTERS_SIZE = "w780";
    ...
    public static ArrayList<Movie> getMoviesFromJSON(JSONObject jsonObject){
        ...
        try {
            ...
            for(int i = 0; i < jsonArray.length(); i++){
                ...
                String posterPath = BASE_POSTER_URL + SMALL_POSTERS_SIZE + objectMovie.getString(KEY_POSTER_PATH);
                String bigPosterPath = BASE_POSTER_URL + BIG_POSTERS_SIZE + objectMovie.getString(KEY_POSTER_PATH);
